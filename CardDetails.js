...
import { Image, TextInput, ImageBackground, WebView } from 'react-native';
import {
  Container, Card, Item, Content, CardItem, Button, View, Left, Body,
  Text, Spinner, Form, FooterTab, Tab, Tabs, TabHeading, Icon
} from 'native-base';



type Props = {};
export default class CardDetails extends Component<Props> {
  state = {
    dataComments: [], name: "", comment: "", addingComment: 0,
    places: this.props.navigation.getParam('places')
    , restaurants: this.props.navigation.getParam('restaurants'),
    ToDo: this.props.navigation.getParam('ToDo'),
          ...
          <ImageBackground source={require('./Backgrounds/theme-header.png')} style={{
            ...
            <View style={{ flexDirection: "row" }}>
              ...
              <Button transparent onPress={() =>
                this.props.navigation.navigate(this.state.back,
                  {
