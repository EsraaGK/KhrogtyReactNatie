...
import { Container, Card,  Content, CardItem, Thumbnail,Button, Left,  Body,Right,
  Text,  FooterTab, Tab, Tabs, Footer} from 'native-base';
 
import { withNavigation } from 'react-navigation';

class ResturaceScreen extends Component {
    state = {
      ...
      <Container>
        ...
        <Footer>
          <FooterTab style={{ backgroundColor: "white", justifyContent: "flex-end", alignItems: "flex-end" }}>
            ...
            <Button vertical onPress={() => this.props.navigation.navigate('PlacesScreen' ,{places: this.state.places , 
                restaurants:this.state.restaurants , 
                ToDo:this.state.ToDo})}>
            ...
            <Button vertical>
              <Image source={require('./Icons/grestaurants.png')} style={{ height: 35, width: 35 }} />
              <Text>FOOD</Text>
            </Button>
            <Button vertical onPress={()=>{this.props.navigation.navigate('TodoScreen',{ places: this.state.places , 
                restaurants:this.state.restaurants , 
                ToDo:this.state.ToDo})}}>
...
export default withNavigation(ResturaceScreen);