...
type Props = {};
class TodoScreen extends Component<Props> {
  state = {
    places: this.props.navigation.getParam('places')
    , restaurants: this.props.navigation.getParam('restaurants'), ToDo: this.props.navigation.getParam('ToDo'), flag: 0
  }
      ...
      <Container>
        ...
        <Footer>
          <FooterTab style={{ backgroundColor: "white", justifyContent: "flex-end", alignItems: "flex-end" }}>
            ...
            <Button vertical>
              <Image source={require('./Icons/gtodo.png')} style={{ height: 35, width: 35 }} />
              <Text>TO DO</Text>
            </Button>
          </FooterTab>
        </Footer>
          ...
          <View >
            <Card >
              <CardItem key={elements.id}>
                ...
                <Left style={{ flex: 2, paddingRight:20 }}>
